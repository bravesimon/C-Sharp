...
namespace StudentsWebApplication.Migrations
{
    ...
    [Migration("20231210174357_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentsWebApplication.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("StudentsWebApplication.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("StudentsWebApplication.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StudentsWebApplication.Models.Enrollment", b =>
                {
                    b.HasOne("StudentsWebApplication.Models.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudentsWebApplication.Models.Student", "Student")
                        .WithMany("Enrollments")
